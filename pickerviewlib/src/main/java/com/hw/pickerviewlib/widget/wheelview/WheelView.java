package com.hw.pickerviewlib.widget.wheelview;
...
import com.hw.pickerviewlib.adapter.WheelAdapter;
import com.hw.pickerviewlib.bean.CarBean;
import com.hw.pickerviewlib.bean.DataBean;
import com.hw.pickerviewlib.bean.LeaveBean;
import com.hw.pickerviewlib.listener.OnItemSelectedListener;
import com.hw.pickerviewlib.model.CityBean;
import com.hw.pickerviewlib.model.IPickerViewData;
...
//        }
     ...
     * @return 对应显示的字符串
     */
    private String getContentText(Object item, String label) {
        if (item == null) {
            return "";
        } else if (item instanceof IPickerViewData) {
            return ((IPickerViewData) item).getPickerViewText();
        } else if (item instanceof CityBean) {
            return ((CityBean) item).getName();
        }else if (item instanceof LeaveBean) {
            return ((LeaveBean) item).getType();
        }else if (item instanceof CarBean){
            return ((CarBean) item).getDname();
        }
        else if (item instanceof DataBean) {
            if (((DataBean) item).getDname().contains("依维柯"))
                return ((DataBean) item).getDname();
            else {
                return ((DataBean) item).getDname() + "米";
            }
...
//        else if (item instanceof IndustryResponse.DataBean.IndustryBean) {
//
//            return (( IndustryResponse.DataBean.IndustryBean) item).getTitle();
//        }
//        else if(item instanceof BrandType)
//        {
//            return ((BrandType)item).getBrandType();
//        }
