...
import com.hw.pickerviewlib.adapter.ArrayWheelAdapter;
        ...
        wheelListener_option2 = new OnItemSelectedListener() {
            ...
            public void onItemSelected(int index) {
                ...
                if (mOptions3Items != null) {
                    ...
                    int opt3 = 0;
                    if (index < 0) {
                        ArrayList<CityBean> mOptions3Items_temp = new ArrayList<>();
                        wv_option3.setAdapter(new ArrayWheelAdapter(mOptions3Items_temp));
                        return;
                    }
